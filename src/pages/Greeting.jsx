...
const Greeting = () => {
    ...
    // Load user data fro loader using useLoaderData hook
        ...
        {promptPreloaderValue ? (
            ...
            <h2 className="text-headlineLarge font-semibold text-center tracking-tight text-light-onSurfaceVariant dark:text-dark-onSurfaceVariant">
                <motion.span
                    ...
                    className="bg-gradient-to-r from-teal-400 from-0% via-cyan-500 via-56% to-transparent to-75% bg-[length:350%_100%] bg-[100%_0] 
